...
s32 g_UbiDoobyAutomaticTapFireEnabled = true;
s32 g_UbiDoobyModernAdsCombatEnabled = true;
...
PD_CONSTRUCTOR static void gameConfigInit(void)
{
	...
	configRegisterInt("Game.UbiDooby.AutomaticTapFireEnabled", &g_UbiDoobyAutomaticTapFireEnabled, 0, 1);
	configRegisterInt("Game.UbiDooby.ModernAdsCombatEnabled", &g_UbiDoobyModernAdsCombatEnabled, 0, 1);
